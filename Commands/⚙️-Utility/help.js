    ...
    execute: async(Client, message, args) => {
        if(!args[0]) {
            ...
            .addFields( categories,
                { name: "\u200c", value: ("<a:Arrow_pointing_right:769978144760791082> [Invite](https://dsc.gg/shrekbot) `|` <a:wumpus_coding:801002702552170506> [Support Server](https://discord.gg/CgzBqZjz2v) "), inline: true },
            )
