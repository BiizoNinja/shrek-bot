...
if(!role) return message.channel.send('<:wrong:856162786319925270> You need to specify a role!')
...
if(data) {
    ...
    message.channel.send(`<:greenTick:854228019312066571> Successfully set the Member role to **${role.name}**`)
}; 
