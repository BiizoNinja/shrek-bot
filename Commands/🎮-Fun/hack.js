...
module.exports = {
    ...
    execute: async(Client, message, args) => {
        ...
        if(user) {
         const emails = ["bestguy@gmail.com", "simp1234@hotmail.com", "iliketoeatwood34@gmail.com","fatdiscorddev@outlook.com", `${user.username}_is_single@gmail.com`, "someone@poo.com" ]
         const emailRandomiser = Math.floor((Math.random()* emails.length));

         const passwords = [`${user.username}iscool123`, "hahaImGay@#$", "P@SSW0RD"]
